-- Migration: Broaden relationship types for parent_name in student_details view
-- This ensures that non-traditional guardians (Aunt, Uncle, Grandparent) appear in the students table
...
SELECT 
    ...
    -- Parent name with fallback (now accepts all relationship types if is_primary is true, or falls back to any)
    COALESCE(
